...
public class BeneficiaryDetailsView extends Composite implements Display{
	...
	private VerticalPanel doctorSecondVerticalPanel;
...
//medical details
		...
		patientDetailPanel.add(medicalDetailsPanel);
		
		MedicalDetailsLabel = new Label("Medical Details");
		MedicalDetailsLabel.addStyleName("fieldlabel");
		...
		patientDetailPanel.add(doctorsPanel);
		
		doctorNameLabel = new Label("Current Doctor's Name");
		doctorNameLabel.addStyleName("fieldlabel");
		HTML lastNameHtml = new HTML(doctorNameLabel + "" + html);
		lastNameHtml.setStyleName("mandatoryhtmlpanelinprofiledetailpage");
		
		
		
		doctorSecondVerticalPanel = new VerticalPanel();
		//doctors textbox
		donationNeededTextBox = new TextBox();
		donationNeededTextBox.setName("donationNeededTextBox");
		//donationNeededTextBox.addStyleName("styledoctorstextbox");
		donationNeededTextBox.setMaxLength(20);
		doctorSecondVerticalPanel.add(lastNameHtml);
		doctorSecondVerticalPanel.add(donationNeededTextBox);
		doctorsPanel.add(doctorSecondVerticalPanel);
		...
		hospitalNameTextBox.setName("donationNeededTextBox");
		//hospitalNameTextBox.addStyleName("styledoctorstextbox");
		hospitalNameTextBox.setMaxLength(20);
		...
		/*hospitLabel = new Label("Current Doctor's Name");
